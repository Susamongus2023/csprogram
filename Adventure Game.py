...
while Answer1 not in [1, 2, 3]:
    print("You have been warned. Are you ready to Embark On the Quest of Hawthfire? Type 1 to start, 2 to not start, or 3 for maybe")
    Answer1=int(input())
    anz1=""
...
while Answer3 not in ["ATK", "WALK", "REST"]:
    Answer3=input()
...
while Answer4 not in ["BUY", "REF", "FLI"]:
